...
from api.views import GoodsinfoViewSet,GoodsparameterViewSet,UserViewSet
from rest_framework.urlpatterns import format_suffix_patterns
from rest_framework.routers import DefaultRouter

#===============================================================

goodsinfo_list = GoodsinfoViewSet.as_view({'get':'list','post':'create'})
goodsinfo_detail = GoodsinfoViewSet.as_view({
    'get':'retrieve','put':'update','patch':'partial_update','delete':'destroy'
})

goodsparameter_list = GoodsparameterViewSet.as_view({'get':'list','post':'create'})
